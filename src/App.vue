      ...
      <ul id="nav" class="nav flex-column pt-3 pt-md-0">
        ...
        <li class="nav-item">
          ...
          >
            ...
            <span
              ><img style="width: 25px" src="./assets/logo.png" /> Vue JS</span
            >
          </a>
        </li>
      </ul>
                ...
                <span class="input-group-text" id="topbar-addon">
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      d="M8 4a4
                                                4 0 100 8 4 4 0 000-8zM2 8a6 6 0
      ...
      <div class="row">
        <div class="col-12 col-md-4 col-xl-6 mb-4 mb-md-0">
          <p class="mb-0 text-center text-lg-start">
            © 2021 - <span class="current-year"></span>
            <a
              class="text-primary fw-normal"
              href="https://luifer1994.github.io/"
              target="_blank"
